...
public class ReleasesDirectoryDefaultImpl implements ReleasesDirectory {
    ...
    public String releasesDirectory() {
        ...
        return currentDirectory.currentDirectory() + "update" + File.separator + "releases" + File.separator;
    }
}
