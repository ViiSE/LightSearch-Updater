...
public class InfoDirectoryDefaultTestNG {
    ...
    public void setUpClass() {
        infoDir = new InfoDirectoryDefault(new CurrentDirectoryFromFile());
        expectedInfoDir = System.getProperty("user.dir") + File.separator + "update" + File.separator + "info" + File.separator;
    }
