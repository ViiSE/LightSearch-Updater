...
public class ReleasesDirectoryWindowsImplTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void releasesDirectory() {
        testBegin("ReleasesDirectoryWindowsImpl", "releasesDirectory()");
        ...
        testEnd("ReleasesDirectoryWindowsImpl", "releasesDirectory()");
    }
}
