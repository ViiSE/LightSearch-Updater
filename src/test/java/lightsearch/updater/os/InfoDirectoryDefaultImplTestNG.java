...
public class InfoDirectoryDefaultImplTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void infoDirectory() {
        testBegin("InfoDirectoryDefaultImpl", "infoDirectory()");
        ...
        System.out.println("Info directory: " + infoDirectory.infoDirectory());

        testEnd("InfoDirectoryDefaultImpl", "infoDirectory()");
    }
}
