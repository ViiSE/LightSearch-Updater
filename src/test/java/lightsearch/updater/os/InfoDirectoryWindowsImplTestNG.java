...
public class InfoDirectoryWindowsImplTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void infoDirectory() {
        testBegin("InfoDirectoryWindowsImpl", "infoDirectory()");
        ...
        testEnd("InfoDirectoryWindowsImpl", "infoDirectory()");
    }
}
