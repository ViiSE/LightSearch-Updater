...
public class ReleaseInfoSaverProducerTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    private ReleaseInfoSaverProducer releaseInfoSaverProducer;

    @Test
    public void getReleaseInfoSaverToFileInstance() {
        testBegin("ReleaseInfoSaverProducer", "getReleaseInfoSaverToFileInstance()");

        assertNotNull(releaseInfoSaverProducer, "ReleaseInfoSaverProducer is null!");
        ...
        System.out.println("ReleaseInfoSaver: " + releaseInfoSaver);

        testEnd("ReleaseInfoSaverProducer", "getReleaseInfoSaverToFileInstance()");
    }
}
