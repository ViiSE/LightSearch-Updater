...
public class ReleaseInfoPathProducerTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    private ReleaseInfoPathProducer releaseInfoPathProducer;

    @Test
    public void getReleaseInfoPathDefaultInstance() {
        testBegin("ReleaseInfoPathProducer", "getReleaseInfoPathDefaultInstance()");

        assertNotNull(releaseInfoPathProducer, "ReleaseInfoPathProducer is null!");
        ...
        System.out.println("ReleaseInfoPath: " + releaseInfoPath);

        testEnd("ReleaseInfoPathProducer", "getReleaseInfoPathDefaultInstance()");
    }
}
