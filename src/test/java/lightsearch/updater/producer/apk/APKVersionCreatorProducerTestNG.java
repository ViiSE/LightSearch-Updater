...
public class APKVersionCreatorProducerTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    private APKVersionCreatorProducer apkVersionCreatorProducer;

    @Test
    public void getAPKVersionCreatorDefaultInstance() {
        testBegin("APKVersionCreatorProducer", "getAPKVersionCreatorDefaultInstance()");

        assertNotNull(apkVersionCreatorProducer, "APKVersionCreatorProducer is null!");
        ...
        System.out.println("APKVersionCreator: " + apkVersionCreator);

        testEnd("APKVersionCreatorProducer", "getAPKVersionCreatorDefaultInstance()");
    }
}
