...
public class ReleaseInfoUploaderTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void uploadInfo() {
        testBegin("ReleaseInfoUploader", "uploadInfo()");
        ...
        try {
            String info = (String) releaseInfoUploader.uploadInfo();
            System.out.println("Upload info: \n" + info);
        } catch (ReleaseInfoException ex) {
            catchMessage(ex);
        }

        testEnd("ReleaseInfoUploader", "uploadInfo()");
    }
}
